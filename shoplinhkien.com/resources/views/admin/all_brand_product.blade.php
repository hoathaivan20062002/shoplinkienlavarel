        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('xóa nơi xuất sứ này không?')" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
