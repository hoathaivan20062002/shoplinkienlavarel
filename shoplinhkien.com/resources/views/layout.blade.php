                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="tel:0345096350"><i class="fa fa-phone"></i> 0345096350</a></li>
                                <li><a href="mailto:Ltnhung.20it7@vku.udn"><i class="fa fa-envelope"></i> thaivanhoa2002@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="social-icons pull-right">
                            <ul class="nav navbar-nav">
                                <li><a href="https://www.facebook.com/hoasky202"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://twitter.com"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="https://www.youtube.com"><i class="fa fa-youtube"></i></a></li>
                                <li><a href="https://www.instagram.com"><i class="fa fa-instagram"></i></a></li>
                                <li><a href="https://mail.google.com"><i class="fa fa-google-plus"></i></a></li>
                                {{-- <li><a href=""><i class="fa fa-gapo"></i></a></li> --}}
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/trang-chu')}}"><img src="{{('public/frontend/images/logo0.png')}}" alt="" width="210px;"height=
                                "auto" /></a>
                        </div>
...
{{--     <label for="amount">Sắp xếp theo</label>
                                ...
                                <div class="item active">
                                        ...
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="https://salt.tikicdn.com/cache/750x750/ts/product/34/0a/44/2eead3bc20c64776edf44bbb2ccefb65.jpg.webp" alt="" />
                                                    <h2>149.000  VNĐ</h2>
                                                    <p>Module Kit Arduino Nano Ch340</p>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="https://salt.tikicdn.com/cache/750x750/ts/product/ab/27/2a/2779f715967ad783bbd32928b46c4ab1.jpg.webp" alt="" />
                                                    <h2>289.000 VNĐ</h2>
                                                    <p>Kit Arduino Mega2560 R3- CH340 Thế Hệ 3 ( Tặng Cáp Kết Nối )</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</a>
                                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="https://salt.tikicdn.com/cache/750x750/ts/product/ab/b6/c9/1d716d1a074ffbfcd4caffec1d403dd5.jpg.webp" alt="" />
                                                    <h2>285.000 VNĐ</h2>
                                                    <p>Kit Arduino Mega2560 R3- Atmega16U2</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</a>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="https://salt.tikicdn.com/cache/750x750/ts/product/bc/43/29/6d16b608bd3f22fba415e2cbc06afbae.jpg.webp" alt="" />
                                                    <h2>132,300 VNĐ</h2>
                                                    <p>Mạch Arduino MEGA 2560 HTC TECH- Hàng Chính Hãng</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</a>
                                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="https://salt.tikicdn.com/cache/750x750/ts/product/ff/7d/4b/c68d7c04a6920d2a1c7ff2199306d596.jpg.webp" alt="" />
                                                    <h2>30,000 VNĐ</h2>
                                                    <p>Vỏ hộp bảo vệ cho mạch Arduino Uno R3 nhựa trong suốt</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</a>
                                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="https://salt.tikicdn.com/cache/750x750/ts/product/47/4c/d9/b9fdd30eaa87feb028a81271750e3621.jpg.webp" alt="" />
                                                    <h2>600,000 VNĐ</h2>
                                                    <p>Bộ thí nghiệm Arduino cơ bản</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</a>
                                                </div>
  ...
  <footer class="footer-distributed">
            ...
            <div class="footer-left">
                ...
                <a href="{{URL::to('/trang-chu')}}"><h2>SHOP LINH KIỆN</h2></a>
                ...
                <p class="footer-links">
                    ...
                    <a href="/baocao/Báo cáo đồ án cơ sở II.doc">GIỚI THIỆU</a><br>

                    <a href="http://localhost:8080/shoplinhkien.com/admin">QUẢN TRỊ</a>

                    <a href="#">LIÊN HỆ</a>
                </p>

                   {{-- <center><p class="footer-company-name">Copy right © 2022 by VanHoa</p></center> --}}
            ...
            <div class="footer-center">
                ...
                <div>
                    <a href="tel:0345096350"><i class="fa fa-phone"></i></a>
                    <p>0345096350</p>
                </div>

                <div>
                    <a href="mailto:thaivanhoa2002@gmail.com"><i class="fa fa-envelope"></i></a>
                    <p>thaivanhoa2002@gmail.com</p>
                </div>
            ...
            <div class="footer-right">
                ...
                <div class="footer-icons">
                    ...
                    <a href="https://www.facebook.com/hoasky202"><i class="fa fa-facebook"></i></a>
                    <a href="https://www.instagram.com/vanhoa2622/"><i class="fa fa-instagram"></i></a>
                    <a href="https://www.youtube.com/channel/UClRIXXTA4U6ZCDqldi4zKxQ"><i class="fa fa-youtube"></i></a>
        ...
        <center><p class="footer-company-name">Copy right © 2022 by <a href="https://www.facebook.com/hoasky202">VĂN HÒA</a></p></center>
</div>
