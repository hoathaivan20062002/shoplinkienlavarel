            ...
            {{--      <li class="sub-menu">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-brand-product')}}">Thêm xuất sứ sản phẩm</a></li>
                        <li><a href="{{URL::to('/all-brand-product')}}">Liệt kê xuất sứ sản phẩm</a></li>
 ...
 <!-- footer -->
          <div class="footer">
            <div class="wthree-copyright">
              <p>©2022 Visitors. All rights reserved | Design by <a href="https://www.facebook.com/hoasky202">VĂN HÒA</a> </p>
            </div>
          </div>
  <!-- / footer -->
</section>
